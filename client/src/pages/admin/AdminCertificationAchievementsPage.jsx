...
const typeStyles = {
  ...
  license: "bg-violet-50 text-violet-700",
...
function getEvidenceKind(mediaUrl) {
  ...
  try {
    ...
    if (/\.(?:jpe?g|png|webp|avif|gif|svg)$/.test(pathname)) {
      return "image";
    }
      ...
      <div className="mt-4 overflow-hidden rounded-xl border border-slate-200 bg-slate-100">
        ...
        <div className="flex items-center justify-between gap-3 border-t border-slate-200 bg-white px-4 py-3">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-sm font-semibold text-brand-600 transition-colors hover:text-brand-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-2 motion-reduce:transition-none"
          >
            Open Media
          </a>
        </div>
  ...
  return (
    <div className="mt-4 rounded-xl border border-slate-200 bg-slate-50 p-4">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="mt-3 inline-flex min-h-10 items-center justify-center rounded-xl border border-slate-300 bg-white px-3.5 text-sm font-semibold text-brand-700 transition-colors hover:border-brand-300 hover:bg-brand-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 focus-visible:ring-offset-2 motion-reduce:transition-none"
      >
        View Evidence
      </a>
    </div>
        ...
        <header className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
              Manage certifications, licenses, awards and independent
              achievements with publication, expiration and evidence controls.
            </p>
          </div>
          ...
          <div>
            ...
            {!isLoading && (
              <p className="mt-1 text-xs text-slate-500">
                Showing Certifications & Achievements matching the applied
                filters.
              </p>
            )}
          </div>
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex min-w-0 items-start gap-3">
                      <div className="grid size-12 shrink-0 place-items-center rounded-xl bg-slate-950 text-sm font-bold text-white">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    <span
                      className={`rounded-lg px-2.5 py-1 text-xs font-bold ${typeStyle}`}
                    >
                      {typeLabel}
                    </span>
                  ...
                  {achievement.credentialId && (
                    <div className="mt-4">
                      <p className={labelClassName}>Credential ID</p>
                  ...
                  <div className="mt-auto grid grid-cols-2 gap-2 pt-5">
                    ...
                    <button
                      ...
                      disabled={
                        actionAchievementId !== "" || !canDeleteAchievements
                      }
                      title={
