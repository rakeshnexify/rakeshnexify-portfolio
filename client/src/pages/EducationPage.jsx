          ...
          <Container>
            <div className="rounded-3xl bg-slate-950 px-6 py-10 text-center text-white sm:px-10">
              ...
              <h2 className="mx-auto mt-4 max-w-3xl text-2xl font-bold tracking-tight sm:text-4xl">
                Looking for a developer who combines learning with practical
                project experience?
              </h2>

              <p className="mx-auto mt-5 max-w-2xl leading-7 text-slate-300">
                Share your project requirements, preferred technology and
                timeline to begin a practical development discussion.
              </p>
